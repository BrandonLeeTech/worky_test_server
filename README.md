# Project Overview
本專案用自建 API 測試 Worky APP，主要用來餵資料
...
打開 Apache Server (port:80) 後，前往

👉 **['測試前台'](http://192.168.1.111/worky_test_server/frontend/index.html)**

👉 **['測試前台(本地回環)'](http://127.0.0.1/worky_test_server/frontend/index.html)**

打開 uvicorn (port:8000) 後，前往

👉 **['快速測試後端'](http://192.168.1.111:8000)**

👉 **['測試前台(本地回環)'](http://localhost:8000/)**
